...
def get_default_temp_profile() -> str:
    ...
    if sys.platform.startswith('win'):
        return "--user-data-dir=C:\\temp\\unified-job-applier-profile"
    elif sys.platform.startswith('linux'):
        return str(home / ".unified-job-applier-profile")
    return str(home / "Library" / "Application Support" / "Google" / "Chrome" / "unified-job-applier-profile")
