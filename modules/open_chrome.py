...
def createChromeSession(isRetry: bool = False):
    ...
    if isRetry:
        ...
        import tempfile
        fresh_profile = tempfile.mkdtemp(prefix="unified-job-applier-profile-")
        print_lg("Logging in with a completely fresh guest profile, Web history will not be saved!")
